...
import { FaEdit, FaUserShield, FaTimes } from "react-icons/fa"; // Add FaTimes for the delete icon
import { ImBlocked } from "react-icons/im";
import { useState, useEffect } from "react";
import useAxiosPublic from "../../hooks/useAxios";
...
const AllUsers = () => {
  ...
  const handleDelete = async () => {
    try {
      await axiosInstance.delete(`/user/${selectedUser._id}`); // API request to delete user
            ...
            <tr key={user._id} className="hover:bg-gray-100">
              ...
              <td className="py-2 px-4 border">
                <div className=" text-base flex items-center">
                  ...
                  <button
                    onClick={() => openEditModal(user)}
                    className="mr-2 p-2 rounded-full text-yellow-500"
                    title="Edit User"
                  >
                    <FaEdit />
                  </button>
